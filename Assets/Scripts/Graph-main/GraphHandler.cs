...
using static StockPriceManager;
...
public class GraphHandler : MonoBehaviour
{
    ...
    //    for(int i = 0; i < 10; i++)
    //    {
    //        CreatePoint(new Vector2(indx, 0.2f * indx + i));
    //        indx++;
    //    }
    ...
    private void ExampleFunction(Dictionary<StocksScriptableObject, StockPriceManager.StockValues> stocksDict)
    {
        currentPrice = stocksDict[stockToWatch].currentPrice;
        CreatePoint(new Vector2(indx, currentPrice));
        indx++;
        UpdateGraph();
    }
    #endregion
    ...
    private Vector2 currentPointPos = Vector2.zero;
